        ...
        <div className="bg-white-A700 flex flex-col justify-start p-[69px] md:px-10 sm:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-12 items-center justify-start max-w-[1082px] mt-[70px] mx-auto w-full">
            ...
            <div className="flex md:flex-1 flex-col items-center justify-start w-[61%] md:w-full">
              ...
              >
                <div className="bg-pink-300 hover:cursor-pointer flex flex-1 md:flex-col flex-row gap-9 items-center justify-start hover:my-0 my-0 p-[17px] rounded-[15px] hover:shadow-bs2 shadow-bs2 w-full">
                  ...
                  <div className="md:h-[46px] h-[87px] relative w-[78%] md:w-full">
                    <Text
                      className="absolute inset-x-[0] mx-auto sm:text-4xl md:text-[38px] text-[40px] text-gray-900_01 top-[0] w-max"
                      size="txtInterBlack40Gray90001"
                    >
                      CINTARA SURYA PALOH
                    </Text>
                    <Text
                      className="absolute bottom-[0] left-[0] text-4xl sm:text-[32px] md:text-[34px] text-gray-900_01"
                      size="txtInterBold36"
                    >
                      78%
                    </Text>
          ...
          <Text
            className="mb-[72px] md:ml-[0] ml-[534px] mt-[43px] md:text-3xl sm:text-[28px] text-[32px] text-red-A700"
            size="txtInterBold32RedA700"
          >
            ANDA SUDAH MEMILIH !!!!
          </Text>
        </div>
