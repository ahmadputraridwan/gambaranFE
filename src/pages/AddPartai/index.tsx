...
const AddPartaiPage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter sm:gap-10 md:gap-10 gap-[70px] items-center justify-start mx-auto pb-11 w-full">
        ...
        <div className="flex md:flex-col flex-row gap-[57px] items-start justify-center max-w-[1005px] mx-auto md:px-5 w-full">
          <Img
            ...
            alt="imageOne"
          />
          <div className="flex md:flex-1 flex-col gap-[46px] items-start justify-start w-[58%] md:w-full">
            <div className="flex flex-col items-start justify-start w-full">
              ...
              <div className="bg-white-A700 border-2 border-gray-700 border-solid h-[139px] mt-1 rounded-[15px] w-full"></div>
              <Text
                className="mt-[15px] text-2xl md:text-[22px] text-gray-700 text-justify sm:text-xl"
                size="txtInterBold24Gray700"
              >
