  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto w-full">
        <div className="bg-white-A700 flex flex-col items-center justify-center p-[29px] sm:px-5 rounded-[25px] w-full">
          <div className="flex flex-col justify-start max-w-[1081px] mx-auto my-[23px] md:px-5 w-full">
            <Text
              className="md:ml-[0] ml-[216px] text-5xl sm:text-[38px] md:text-[44px] text-light_green-900"
            ...
            >
              ...
              <div className="md:h-[385px] h-[395px] relative w-full">
                ...
                <Text
                  className="absolute bg-gray-500 border-[3px] border-solid border-white-A700 h-[90px] justify-center pl-[35px] pr-8 sm:px-5 py-[25px] right-[0] rounded-[50%] md:text-3xl sm:text-[28px] text-[32px] text-white-A700 top-[0] w-[90px]"
                  size="txtInterBold32"
                >
                  2
                </Text>
              ...
              <div className="md:h-[385px] h-[395px] relative w-full">
                ...
                <Text
                  className="absolute bg-gray-500 border-[3px] border-solid border-white-A700 h-[90px] justify-center pl-[35px] pr-[31px] sm:px-5 py-[25px] right-[0] rounded-[50%] md:text-3xl sm:text-[28px] text-[32px] text-white-A700 top-[0] w-[90px]"
                  size="txtInterBold32"
                >
                  3
                </Text>
